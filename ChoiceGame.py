...
def game():
    print ("""\nYou find yourself on an alien ship, cruising in the outer reaches
     ...
     """, username, """WANTED, dead is preferred.' So, you start running to find a way out.""")
    ...
    if first_choice == "1":
        ...
        second_choice = input("Type 1, 2, or 3 below. \n")
        print ("-"*90)
        ...
        if second_choice == "1":
            ...
            third_choice = input("You enter the following code into the pad:\n")
...
print ("So you want to be called""", username, """?""")
confirm = input("Type Y if yes, type N if you would like to exit the game:\n")
